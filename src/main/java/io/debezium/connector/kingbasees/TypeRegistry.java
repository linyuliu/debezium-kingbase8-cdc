...
import io.debezium.connector.kingbasees.connection.PostgresConnection;
...
public class TypeRegistry {
    ...
    private static Map<String, String> getLongTypeNames() {
        ...
        longTypeNames.put("int", "int4");
        longTypeNames.put("int2", "int2");
        longTypeNames.put("int4", "int4");
        longTypeNames.put("int8", "int8");
        longTypeNames.put("bigint", "int8");
        longTypeNames.put("number", "numeric");
        longTypeNames.put("decimal", "numeric");
        longTypeNames.put("dec", "numeric");
        ...
        longTypeNames.put("float", "float4");
        longTypeNames.put("double", "float8");
        longTypeNames.put("binary_float", "float4");
        longTypeNames.put("binary_double", "float8");
    ...
    public PostgresType get(String name) {
        if (name == null || name.isEmpty()) {
            LOGGER.warn("Empty type name requested");
        ...
        if (dotIndex >= 0 && dotIndex + 1 < name.length()) {
            name = normalizeTypeName(name.substring(dotIndex + 1));
        }
    ...
    */
    ...
    public static String normalizeTypeName(String typeName) {
        ...
        return LONG_TYPE_NAMES.getOrDefault(normalized, normalized);
    }
     ...
     * {@link KbDatabaseMetaData#getTypeInfo()} as the latter causes N+1 SELECTs, making it very slow on installations
    ...
    private static class SqlTypeMapper {
        ...
        /**
         * Based on com.kingbase8.jdbc.TypeInfoCache.getSQLType(String). To emulate the original statement's behavior
        ...
        private SqlTypeMapper(Connection db, TypeInfo typeInfo) throws SQLException {
            ...
            this.preloadedSqlTypes = Collect.unmodifiableSet(typeInfo.getKBTypeNamesWithSQLTypes());
