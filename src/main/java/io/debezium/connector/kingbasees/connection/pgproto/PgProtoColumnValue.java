...
import io.debezium.connector.kingbasees.PgOid;
...
import io.debezium.connector.kingbasees.connection.AbstractColumnValue;
...
public class PgProtoColumnValue extends AbstractColumnValue<PgProto.DatumMessage> {
    ...
    public boolean isNull() {
        return value.hasDatumNull() || value.hasDatumMissing();
    }
    ...
    public Object asArray(String columnName, PostgresType type, String fullType, PgConnectionSupplier connection) {
        ...
        try {
            ...
            LOGGER.warn("Unexpected exception trying to process KbArray column '{}'", value.getColumnName(), e);
        }
        return null;
    }
    ...
    public Object asDefault(TypeRegistry typeRegistry, int columnType, String columnName, String fullType, boolean includeUnknownDatatypes,
        ...
        LOGGER.warn("Unknown column type '{}' for column '{}', fallback to UTF-8 string", fullType, columnName);
