...
public interface ReplicationConnection extends AutoCloseable {
     ...
     * </p>
     *
     * @return a {@link KBReplicationStream} from which data is read; never null
     ...
     * @return a {@link KBReplicationStream} from which data is read; never null
     * @see com.kingbase8.replication.LogSequenceNumber
    ...
    interface Builder {
         ...
         * @return this instance
         * @see PostgresConnectorConfig.TruncateHandlingMode
         */
